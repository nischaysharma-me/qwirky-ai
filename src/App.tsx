  ...
  return (
    <HologramProvider>
      <main className="relative w-screen h-screen overflow-hidden bg-[#080b15]">
        ...
        <header className="fixed top-5 left-6 right-6 z-20 flex items-center justify-between pointer-events-none select-none">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-lg bg-gradient-to-tr from-amber-500/20 to-purple-500/20 border border-white/10 flex items-center justify-center backdrop-blur-md">
              <Brain className="w-4 h-4 text-amber-300" />
            </div>
            <div>
              <h1 className="text-sm font-bold tracking-[0.25em] font-mono-hud text-slate-100 uppercase">
                QWIRKY <span className="text-amber-400 font-normal">NEURAL AI</span>
              </h1>
              <p className="text-[10px] tracking-widest text-slate-400 font-mono-hud uppercase">
                Synaptic Brain Matrix · React-Three-Fiber
              </p>
            </div>
          </div>
          ...
          <div className="hidden md:flex items-center gap-2 px-3 py-1.5 rounded bg-black/40 border border-white/10 text-[10px] font-mono-hud tracking-wider text-slate-400 backdrop-blur-md">
            ...
            <span>DRAG: ROTATE &middot; SCROLL: ZOOM &middot; CLICK: PULSE SHOCK</span>
          </div>
        </header>
